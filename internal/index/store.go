...
type VectorStore interface {
	...
	// SearchRejected returns scope-matched candidates that scored below
	// threshold, for --debug diagnostics only. Callers must only invoke
	// this inside an `if debug` branch -- see docs/arch/0008.
